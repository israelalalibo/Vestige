  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 pt-24 pb-16">
      <div className="w-full max-w-sm">
        <h1 className="font-display text-3xl font-light mb-2 text-center">Create account</h1>
        <p className="text-vestige-gray text-sm text-center mb-8">Join Vestige for early access & order tracking</p>

        <button
          onClick={() => signIn('google', { callbackUrl: '/account' })}
          className="w-full flex items-center justify-center gap-3 border border-gray-300 py-3 text-sm hover:bg-gray-50 transition-colors mb-6"
        >
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-[10px] tracking-widest uppercase text-vestige-gray">or</span>
          <div className="flex-1 h-px bg-gray-200" />
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs tracking-widest uppercase text-vestige-gray mb-2">Name</label>
            <input
          ...
          <div>
            <label className="block text-xs tracking-widest uppercase text-vestige-gray mb-2">Password</label>
            <input
              type="password" required minLength={8} value={form.password} onChange={update('password')}
              className="w-full border border-gray-300 px-4 py-3 text-sm focus:outline-none focus:border-vestige-black transition-colors"
            />
            <p className="text-[11px] text-vestige-gray mt-1.5">At least 8 characters</p>
          </div>
