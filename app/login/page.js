  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 pt-24 pb-16">
      <div className="w-full max-w-sm">
        <h1 className="font-display text-3xl font-light mb-2 text-center">Welcome back</h1>
        <p className="text-vestige-gray text-sm text-center mb-8">Sign in to your Vestige account</p>
