...
async function main() {
  ...
  // Note: analytics (visits, abandoned carts, buyer locations, returns) are
  // intentionally NOT seeded — those dashboards populate from real activity
  // and the daily rollup cron.
